...
- **Playwright** is pre-installed — do NOT run `npx playwright install chromium`, it's already available. Just use `npx playwright screenshot` or `npx playwright` directly.
